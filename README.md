...
### Overview
This project implements a simple Retrieval-Augmented Generation (RAG) pipeline that answers user queries using internal construction documents. The assistant retrieves relevant document chunks and generates answers strictly grounded in retrieved content.

### Embeddings & Retrieval
- TF-IDF embeddings using scikit-learn
- Cosine similarity for semantic retrieval
- Top-k retrieval with a similarity score threshold to avoid weak matches
